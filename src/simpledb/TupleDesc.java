...
public class TupleDesc {
	...
	public Type getType(int i) throws NoSuchElementException {
		if (i < types.length){
			...
			throw new NoSuchElementException("Please check Index given and re-implement this");
		}
	}
	...
	public String toString() {
		String descriptor = "";
		for(int i = 0; i < types.length; i++) {
			descriptor += types[i]  + "("+names[i]+")"+ "|"; 
		}
		descriptor = descriptor.substring(0, descriptor.length()-1); //removed last "|" with substring the descriptor
        return descriptor;
	}
}
